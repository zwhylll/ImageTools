...
class Win_ls_Videowatermark_2:
    ...
    def __init__(self):
        ...
        self.ui = QUiLoader().load('ls_videoWaterMark_2.ui')
    ...
    def addwatermark(self):
        ...
        if (len(road) == 0 or len(infileName) == 0):
            ...
            wlog(infileName, outfileName, "视频批量文字水印")
