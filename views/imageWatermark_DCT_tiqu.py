...
class Win_watermark_DCT_tiqu:
    ...
    def __init__(self):
        ...
        self.ui = QUiLoader().load('imageWatermark_DCT_tiqu.ui')
    ...
    def compressImage(self):
        ...
        if (len(road) == 0 or len(infileName) == 0):
            ...
            wlog(infileName, outfileName, "DCT水印提取")
            DCT_tiqu(lens,infileName,outfileName)
