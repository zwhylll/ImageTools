...
class Win_watermark_imagedown_tiqu:
    ...
    def __init__(self):
        ...
        self.ui = QUiLoader().load('imageWatermark_image_tiqu.ui')
    ...
    def compressImage(self):
        ...
        if (len(road) == 0 or len(infileName) == 0):
            ...
            wlog(infileName, outfileName, "LSB图片水印提取")
            Image1_tiqu(infileName,outfileName)
...
if __name__ == '__main__':
    app = QApplication([])
    main = Win_watermark_imagedown_tiqu()
    main.ui.show()
    sys.exit(app.exec_())