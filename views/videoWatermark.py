...
class Win_Videowatermark:
    ...
    def __init__(self):
        ...
        self.ui = QUiLoader().load('videoWaterMark.ui')
    ...
    def addwatermark(self):
        ...
        if (len(road) == 0 or len(infileName) == 0):
            ...
            wlog(infileName, outfileName, "视频文字水印")
            addWaterMark(infileName,outfileName,w,h,float(lut),fontsize,text,color)
        #self.ui.label.setScaledContents(True);
        #self.ui.label.setPixmap(QPixmap(outfileName.encode('utf-8')))
