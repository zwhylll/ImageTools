...
# import requests
from controllor.getfilename import SearchFiles, getoutfileName, SearchVideoFiles
...
class Win_ls_Vwatermark:
    ...
    def __init__(self):
        ...
        self.ui = QUiLoader().load('ls_videoWatermark.ui')
