...
from views.imageWatermark_DCT import Win_watermark_DCT
from views.imageWatermark_DCT_tiqu import Win_watermark_DCT_tiqu
from views.imageWatermark_image import Win_watermark_imagedown
from views.imageWatermark_image_tiqu import Win_watermark_imagedown_tiqu
...
class Win_imagedown :
    ...
    def __init__(self):
        self.ui = QUiLoader().load('imagedown_water.ui')
    ...
    def wirte_lsb(self):
        newwin.testWin = Win_watermark_imagedown()
        newwin.testWin.ui.show()
    def get_lsb(self):
        newwin.testWin = Win_watermark_imagedown_tiqu()
        newwin.testWin.ui.show()
