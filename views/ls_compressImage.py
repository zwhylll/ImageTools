...
# import requests
from controllor.getfilename import *
# from lib.share import SI
from controllor.relog import wlog


class Win_ls_imageCompress:
    ...
    def __init__(self):
        ...
        self.ui = QUiLoader().load('ls_imageCompress.ui')
    ...
    def compressImage(self):
        ...
        # outfile =
        imagetpye = self.ui.imageTypeBox.currentText()
        ...
        if (len(road) == 0 or len(infileName) == 0):
            ...
            wlog(infileName, outfileName, "图像批量压缩")
