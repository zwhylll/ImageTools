...
class Win_watermark_imagedown:
    ...
    def __init__(self):
        ...
        self.ui = QUiLoader().load('imageWatermark_image.ui')
    ...
    def compressImage(self):
        ...
        if (len(road) == 0 or len(infileName) == 0):
            ...
            wlog(infileName, outfileName, "LSB图片水印隐写")

            Image1_yinxie(infileName,textfileName,outfileName)
            self.msg1()
