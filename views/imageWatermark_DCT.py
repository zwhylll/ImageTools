...
class Win_watermark_DCT:
    ...
    def __init__(self):
        ...
        self.ui = QUiLoader().load('imageWatermark_DCT.ui')
    ...
    def compressImage(self):
        ...
        if (len(road) == 0 or len(infileName) == 0 or len(textfileName)==0):
            self.msg2()
        else:
            wlog(infileName, outfileName, "DCT水印隐写")

            DCT_yinxie(infileName,textfileName,outfileName)
            self.msg1()
